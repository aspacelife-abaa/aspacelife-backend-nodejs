...
const ValidUSERS = (d)=>{
  return new Promise((resolve) => {
    ...
    list.push("nasirlawal001@gmail.com");
    list.push("nasirlawal003@gmail.com");
    list.push("jackalsolutions@gmail.com");
    list.push("folarinjunior2@gmail.com");
    list.push("folarin@aspacelife.com");
    list.push("mustaphavalleyocean@gmail.com");
    list.push("effahnnamso2@gmail.com");
    list.push("trueisrael4life@gmail.com");
    list.push("marsjjdjdj@shh.com");
    list.push("vgfx4u@yahoo.com");
    list.push("sgshsh@yahoo.com");
    list.push("marshall.voguepay001@gmail.com");
    list.push("Marshalgfx@gmail.com");
    list.push("jackalsolutions2@gmail.com");
    list.push("Vgfx4u@yahoo.com");
    list.push("Truepower4life@gmail.com");
    list.push("aspacelifetechltd@gmail.com");
    list.push("truepower4life@gmail.com");
    list.push("ejimemekah@yahoo.com");
    list.push("infowaves.com@googlemail.com");
    list.push("harunamusaaguye@gmail.com");
    list.push("umohammedkabiru@gmail.com");
    list.push("simonabutu83@gmail.com");
    list.push("godwin.atole@gmail.com");
    list.push("Mohammedabbaya@gmail.com");
    list.push("Chikeigwe2000@gmail.com");
    list.push("effahcology001@gmail.com");
    list.push("senkebengeonlyn@gmail.com");
    list.push("ediyoung4christ@gmail.com");
    list.push("goldenpie2019@gmail.com");
    list.push("edetetimfon@gmail.com");
    list.push("omoneprecious7@gmail.com");
    list.push("idarapaul0@gmail.com");
    list.push("iyiobavictorpaul@gmail.com");
    list.push("Ogarekpeobu@gmail.Com");
    list.push("ekaetteeffah@yahoo.com");
    list.push("thredcoy@gmail.com");
    list.push("abasido.moses@gmail.com");
    list.push("eddykentr1@gmail.com");
    list.push("victoriyke33@gmail.com");
    list.push("Wealthdimensionfx@qmail.com");
    list.push("wwarrie7@gmail.com");
    list.push("Princeemetu@gmail.com");
    list.push("princeemetu@gmail.com");
    list.push("glorynkata225@gmail.com");
    list.push("ekerekeekemini@yaho.com");
    list.push("wwarrie7@gmail.com");
    list.push("ruth.adison@icloud.com");
    list.push("nickyparis6@gmail.com");
    list.push("nsijumbo@yahoo.co.in");
    list.push("ejimemekah@yahoo.com");
    list.push("adebayosaeedbaba@gmail.com");
    list.push("onigahagnesagbo@gmail.com");
    list.push("ajorthomas@yahoo.com");
    list.push("Inahadie77@gmail.com");
    list.push("michael.eneje@yahoo.com");
    list.push("pafrank2016@gmail.com");
    list.push("Uselect8@gmail.com");
    list.push("tomalims@gmail.com");
    list.push("hasheemyousuph@gmail.com");
    list.push("Ogunmolasura@yahoo.com");
    list.push("Etimeffanga776@gmail.com");
    list.push("agbaogbangagba@gmail.com");
    list.push("isaayobami@gmail.com");
    list.push("akanumotong@gmail.com");
    list.push("emmamoses8@gmail.com");
    list.push("oluobanla@outlook.com");
    list.push("aremzimahlukmon@gmail.com");
    list.push("pristinefinishings@gmail.com");
    list.push("senkebengeonlyn@gmail.com");
    list.push("Id4rose@gmail.com");
    list.push("odam4real@gmail.com");
    list.push("alihchris@gmail.com");
    list.push("ruqayahjubril@gmail.com");
    list.push("angelaogbudu97@gmail.com");
    list.push("okosims@gmail.com");
    list.push("nobleakwajiclement@gmail.com");
    list.push("ajabafrancis@gmail.com");
    list.push("lambertessien@yahoo.co.uk");
    list.push("adebayoismaeel@gmail.com");
    list.push("jossymcb@yahoo.com");
    list.push("akwajiaustine1990@gmail.com");
    list.push("oaagba01@yahoo.com");
    list.push("timsy4style@gmail.com");
    list.push("princessbusola4060@gmail.com");
    list.push("excellency144@gmail.com");
    list.push("ugwuokehelenchioma@gmail.com");
    list.push("boldnbiutiful@gmail.com");
    list.push("jullyadah@gmail.com");
    list.push("faithjonathan462@gmail.com");
    list.push("deborahdajai@gmail.com");
    list.push("08032520241");
    list.push("08055988030");
    list.push("07064647313");
    list.push("07057974237");
    list.push("07032545854");
    list.push("09155566559");
    list.push("09115876162");
    list.push("07068808025");
    list.push("07068608025");
    list.push("08187469770");
    list.push("08035589263");
    list.push("09027794494");
    list.push("08163036664");
...
const ForceUpdate = (d)=>{
  return new Promise((resolve) => {
    resolve({status:true,data:"8.0",message:""})
  })
}
...
const PostAssets = (d)=>{
  return new Promise((resolve) => {
    let list = [];
    const baseUrl = "https://abaapay.marshalsoft.pro";
    list.push({value:`${baseUrl}/social_feed_assets/layer-1.png`,variance:"dark",type:"img"});
    list.push({value:`${baseUrl}/social_feed_assets/layer-2.png`,variance:"light",type:"img"});
    list.push({value:`${baseUrl}/social_feed_assets/layer-3.png`,variance:"dark",type:"img"});
    list.push({value:`${baseUrl}/social_feed_assets/layer-4.png`,variance:"light",type:"img"});
    resolve({status:true,data:list,message:""});
  })
}
